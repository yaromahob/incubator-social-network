...
import {addLikeCallback, TUserData, TUserMessages, TUserPost} from "./redux/state";
import {v1} from 'uuid';
		...
		<div className='app-wrapper'>
			...
			<main>
				...
				<div className="content-body">
					<Route path="/profile"
								 render={() => <Profile
									 postUser={props.state.profilePage.userPosts}
									 newPostCallback={props.newPostCallback}
